      ...
      <ul className="taxes__list">
        <li className="container">
          ...
          <label className="output output_place_taxes">
            <output className="output__line output__line_type_taxes-month" name="taxes-month">24545</output>
            &nbsp;₽
          </label>
        </li>
        <li className="container">
          ...
          <label className="output output_place_taxes">
            <output className="output__line output__line_type_taxes-year" name="taxes-year">294540</output>
            &nbsp;₽
          </label>
        </li>
        <li className="container">
          ...
          <label className="output output_place_taxes">
            <output className="output__line output__line_type_taxes-five-year" name="taxes-five-year">1472700</output>
            &nbsp;₽
          </label>
        </li>
      </ul>
